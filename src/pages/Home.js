        ...
        <div className="home-content">
            ...
            <div className="hero-section fade-in">
                ...
                <button className="join-button slide-in">
                    <Link to="/login" className="join-link">Join Us</Link>
                </button>
            </div>
            ...
            <div className="topics-overview">
                ...
                <div className="topic-cards">
                    <div className="topic-card slide-up">
                        <h3>AWS</h3>
                        <p>Learn about Amazon Web Services, its features, and applications.</p>
                        <button className="button-type">
                            <Link to="/login" className="join-link">Learn More</Link>
                        </button>
                    </div>
                    <div className="topic-card slide-up">
                        <h3>GCP</h3>
